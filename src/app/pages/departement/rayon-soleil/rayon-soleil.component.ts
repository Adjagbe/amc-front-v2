...
@Component({
  selector: 'app-rayon-soleil',
  standalone: true,
  imports: [CommonModule, FormsModule, RouterLink, PaginationComponent],
  templateUrl: './rayon-soleil.component.html',
  styleUrls: ['./rayon-soleil.component.css']
})
export class RayonSoleilComponent implements OnInit {
  membres: Membres[] = [];
  ...
  async loadDepartementInfo(): Promise<void> {
    try {
      ...
      this.departement = departements.find(d => d.libelle === "Rayon de Soleil") || null;
      if (this.departement) {
        this.loadPagination();
      }
    } catch (error) {
