...
@Component({
  selector: 'app-auxiliaire-lydie',
  standalone: true,
  imports: [CommonModule, FormsModule, RouterLink, PaginationComponent],
  templateUrl: './auxiliaire-lydie.component.html',
  styleUrls: ['./auxiliaire-lydie.component.css']
})
export class AuxiliaireLydieComponent implements OnInit {
  membres: Membres[] = [];
  ...
  loadDepartementInfo(): void {
    this.departementsService.getAllDepartements().then((departements: any) => {
      this.departementInfo = departements.find((d: any) => d.libelle === 'Auxiliaire de Lydie') || null;
