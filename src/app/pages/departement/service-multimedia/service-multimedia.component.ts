...
@Component({
  selector: 'app-service-multimedia',
  standalone: true,
  imports: [CommonModule, FormsModule, RouterLink, PaginationComponent],
  templateUrl: './service-multimedia.component.html',
  styleUrls: ['./service-multimedia.component.css']
})
export class ServiceMultimediaComponent implements OnInit {
  membres: Membres[] = [];
  ...
  async loadDepartementInfo(): Promise<void> {
    try {
      ...
      this.departement = departements.find(d => d.libelle === "Service Multimédia") || null;
      if (this.departement) {
        this.loadPagination();
      }
    } catch (error) {
